...
public class calc extends Frame{
    ...
    // buttons for the keypad of the calculator
    String numbButton[] = {"7", "8", "9", "4", "5", "6", 
    "1", "2", "3", "0", "+/-", "." };  }

    String opButton[] = {"/", "sqrt", "*", "%", "-", "1/X", "+", "=" };  

    String memButton[] = { "MC", "MR", "MS", "M+" };

    String sButton[] = {"Backspc", "C", "CE" };  
  
    MyNumberButton numberButton[]=new MyNumberButton[numbButton.length];  
    MyOpButton operatorButton[]=new MyOpButton[opButton.length];  
    MyMemButton memoryButton[]=new MyMemButton[memButton.length];  
    MySButton specialButton[]=new MySButton[sButton.length];  
    ...
    {  
        ...
        {  
            numberButton[i]=new MyDigitButton(tempX,y,WIDTH,HEIGHT,digitButtonText[i], this);  
    ...
    MyOperatorButton(int x,int y, int width,int height,String cap, calc clc)  
    {  
    super(cap);  
    setBounds(x,y,width,height);  
    this.cl=clc;  
    ...
    if(opText.equals("1/x"))  
        ...
        try  
            ...
            cl.displayLabel.setText(calc.getFormattedText(tempd));}  
    ...
    cl.displayLabel.setText(calc.getFormattedText(temp));  
    //cl.number=temp;  
    }//actionPerformed  
    }//class  
    ...
    class MyMemButtonextends Button implements ActionListener  
    {  
    calc cl;  
    ...
    case 'R':   
        cl.displayLabel.setText(calc.getFormattedText(cl.memValue));break;  
    case 'S':  
        cl.memValue=0.0;  
    case '+':   
    ...
    MySpecialButton(int x,int y, int width,int height,String cap, calc clc)  
    {  
    super(cap);  
    setBounds(x,y,width,height);  
    this.cl=clc;  
